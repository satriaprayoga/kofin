...
import KegiatanField from "./KegiatanField";
import { AiOutlineSave } from "react-icons/ai";


const validationSchema = Yup.object().shape({
    kegiatan_kode: Yup.string().required('Kode harus diisi'),
    kegiatan_name: Yup.string().required('Nama harus diisi'),
})
...
const KegiatanForm=forwardRef((props,ref)=>{
